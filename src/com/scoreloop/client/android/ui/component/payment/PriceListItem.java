...
public class PriceListItem extends StandardListItem<Price> {
	...
	public PriceListItem(final ComponentActivity activity, final Price target) {
		super(activity, null, target.getCurrency(), String.format("%.2f", target.getAmountInUnits()), target);
	}
