...
public interface ScreenActivityProtocol {
	...
	boolean isNavigationAllowed(final NavigationIntent navigationIntent);

	void setShortcuts(ScreenDescription description);
	...
	void startTabBody(ScreenDescription description, int anim);
