...
/**
 * The SocialMarketScreenActivity is used to 
 * inform the user about other Scoreloop enabled games. 
 *
 * Basic Usage:
 * -# Ensure that the ScoreloopManagerSingleton has been properly
 *    intialized.
 * -# Start the SocialMarketScreenActivity using an <a href="http://developer.android.com/reference/android/content/Intent.html">android.content.Intent</a>.
 *
 * \sa @link scoreloopui-integratemarket Social Market Integration Guide@endlink
 */
